...
public final class RaycastUtils {
    ...
    public static Entity raycastEntity(final double range, final Rotation rotation, final IEntityFilter entityFilter) {
        return raycastEntity(range, rotation.getYaw(), rotation.getPitch(),
                entityFilter);
    }
