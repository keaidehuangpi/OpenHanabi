...
/**
 * Just copyed from Vanilla Minecraft
...
public class CustomGuiTextField extends Gui
{
    ...
    public CustomGuiTextField(int componentId, FontRenderer fontrendererObj,String hoverText, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                RenderUtil.drawRect(this.xPosition - 0.5f, this.yPosition - 0.5f, this.xPosition + this.width + 0.5f, this.yPosition + this.height + 0.5f, new Color(66, 66, 66).getRGB());
                RenderUtil.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
            }
            ...
            if (!this.isFocused && this.getText().isEmpty()){
                fontRendererInstance.drawString(hoverText,(xPosition + 5),(yPosition - (this.fontRendererInstance.FONT_HEIGHT / 2) + this.height / 2),new Color(218, 218, 218).getRGB());
            }
        }
    }
